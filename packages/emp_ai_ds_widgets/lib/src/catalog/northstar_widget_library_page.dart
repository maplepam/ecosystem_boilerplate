...
import '../display/northstar_filter_dropdown.dart';
...
''',
        preview: (BuildContext context) => const _NorthstarFilterDropdownCatalogDemo(),
      ),
      WidgetCatalogEntry(
  ...
  Widget build(BuildContext context) {
    final List<WidgetCatalogEntry> all = <WidgetCatalogEntry>[
      ...
      ...extraEntries,
        ...
        (WidgetCatalogEntry a, WidgetCatalogEntry b) =>
...
class _NorthstarFilterDropdownCatalogDemoState
  ...
  Widget build(BuildContext context) {
    final String? userLabel =
        (_user != null && _user != 'Any') ? _user : null;
    final String? roleLabel = _role;

    final List<String> locList = _locations.toList();
    locList.sort();
    final String? locationPrimary =
        locList.isEmpty ? null : locList.first;
    final int locationExtra =
        locList.length > 1 ? locList.length - 1 : 0;
